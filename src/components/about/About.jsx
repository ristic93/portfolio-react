    ...
    <section id="about">
      ...
      <article className="container about_container" data-aos="zoom-in-right">
        <div className="text">
          ...
          <p style={{ fontSize: "1.1rem" }}>
            I develop websites with HTML{" "}
            <DiHtml5 style={{ color: "#dd4b25", fontSize: "1.4rem" }} />, CSS{" "}
            <DiCss3 style={{ color: "#254bdd", fontSize: "1.4rem" }} /> and
            JavaScript
            <DiJavascript1 style={{ color: "#e8de4e", fontSize: "1.4rem" }} />.
            I love taking complex problems and turning them into simple{" "}
