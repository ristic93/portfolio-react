    ...
    <section id='about'>
        ...
        <article className="container about_container">
            <div className="text">
                ...
                <p style={{fontSize: '1.1rem'}}>Ambitious, hard-working and organized. Communicative, creative and resourceful. Great problem-solving skills. Reliable team player who is able to adapt to new surroundings <FcPortraitMode className='about_icons'/>. </p>
